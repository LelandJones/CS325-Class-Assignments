...
class lab1 {
	...
	public static void main(String[] args) {
		...
		if (gpa >= 3.75 && gpa <= 4.0)
			...
			System.out.println("not on dean's list");
		...
		int values[] = { 17, 8, 24, 16, 2, 56, 76, 1, 45, 32 };
		int large = values[0];
		...
		if (allSame(value1, value2, value3))
			System.out.println(value1 + " same as " + value2 + " same as " + value3);
		else
			System.out.println(value1 + " NOT same as " + value2 + " NOT same as " + value3);
		...
		System.out.println("Average of values[] = " + getAverage(values2));
		System.out.println();
